...
router.get("/listavat", async(req, res) => {
...
///////////////////////////Cree un servicio que permita mostrar la imagen en función de su id,
/////////////usando para ello la función del objeto response sendFile.
